...
public class SysUserController extends JavaEEFrameworkBaseController<SysUser> implements Constant {
	...
	/*//历史资金查询
	@RequestMapping("/capitalintohistory")
	public String capitalintohistory(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/servicemanage/capitalintohistory";
		      //back/bootstrapexample/jquerydatatables
	}
	*/
	//明细查询
	@RequestMapping("/detailinquiry")
	public String detailinquiry(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/infomanage/detailedaccounting";
	}
	...
	public String dataimport(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/infomanage/dataimport";
	}
	
	@RequestMapping("/capitalintohistory")
	public String capitalintohistory(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/infomanage/capitalhistory";
	}
	...
	public String mailsending(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/infomanage/mailsending";
	}
